...
#from lgp.models.teach.hlsm.hlsm_action_repr import HlsmActionRepr
...
class NavToGoalChunkingStrategy:
    ...
    #def _interaction_object_observed(self, state_repr: TeachSpatialStateRepr, action_repr: HlsmActionRepr):
