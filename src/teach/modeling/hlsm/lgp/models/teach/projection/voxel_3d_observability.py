...
import sys
import pdb
from lgp.models.teach.projection.projection_ops import project_3d_camera_points_to_2d_pixels, project_3d_points
...
class Voxel3DObservability(nn.Module):
    ...
    def forward(self,
        ...
        voxel_coordinates_3d_world_meters = voxel_coordinates_3d_world_meters.to(device)
        # Project points into camera pixels
        voxel_coordinates_3d_cam_meters = project_3d_points(extrinsics4f, \
                voxel_coordinates_3d_world_meters)
        ...
        voxel_observability_mask = voxel_observability_mask.to(voxel_grid.data.device)
