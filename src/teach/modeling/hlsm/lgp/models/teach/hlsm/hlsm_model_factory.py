...
from lgp.models.teach.hlsm.hlsm_observation_function import HlsmObservationFunction
from lgp.models.teach.hlsm.hlsm_task_repr import HlsmTaskReprFunction
from lgp.models.teach.hlsm.hlsm_subgoal_model import HlsmSubgoalModel

# Low-level skills
from lgp.models.teach.handcoded_skills.go_for import GoForSkill
from lgp.models.teach.handcoded_skills.go_for_manual import GoForManualSkill
from lgp.models.teach.handcoded_skills.explore_skill import ExploreSkill
from lgp.models.teach.handcoded_skills.interact_skill import InteractSkill
...
class HlsmModelFactory(ModelFactory):
    ...
    def get_skillset(self, exp_def=None) -> Dict[str, Skill]:
        ...
        if self.use_heuristic_gofor_skill:
            ...
            gofor_skill = GoForSkill(exp_def=exp_def)
