...
from lgp.models.teach.hlsm.unets.unet_5 import UNet5

from lgp.ops.depth_estimate import DepthEstimate


class TeachSegmentationAndDepthModel(LearnableModel):
...
lgp.model_registry.register_model("teach_perception_model", TeachSegmentationAndDepthModel)
