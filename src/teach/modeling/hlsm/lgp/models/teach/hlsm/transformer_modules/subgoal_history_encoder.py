...
from lgp.models.teach.hlsm.transformer_modules.positional_encodings import positional_encoding_1d_flat
from lgp.models.teach.hlsm.transformer_modules.transformer_layer import TransformerEncoderLayer
...
class SubgoalHistoryEncoder(nn.Module):
    ...
    def _build_attn_masks(self, batch_id, device, add_sos_tok=False, incl_self=False, force_cpu=True):
        if force_cpu:
            device = "cpu"
