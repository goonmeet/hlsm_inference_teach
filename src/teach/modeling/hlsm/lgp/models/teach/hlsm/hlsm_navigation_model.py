...
class HlsmNavigationModel(LearnableModel):
    ...
    def __init__(self, hparams = None):
        super().__init__()
        self.hidden_dim = 128
        self.feature_2d_dim = TeachSpatialStateRepr.get_2d_feature_dim()
    ...
    def forward_model(self,
        ...
        #ForkedPdb().set_trace()
        features_2d = features_2d.to(subgoal_arg_features.device)
        ...
        # Goal prediction
        #ForkedPdb().set_trace()
        out = self.lingunet(lingin, act_emb, device=act_emb.device)
    ...
    def get_name(self) -> str:
        return "teach_spatial_exploration_model"
...
lgp.model_registry.register_model("teach_spatial_navigation_model", HlsmNavigationModel)
