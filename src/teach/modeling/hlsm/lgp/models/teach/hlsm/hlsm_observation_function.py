...
from lgp.models.teach.projection.image_to_voxels import ImageToVoxels
from lgp.models.teach.projection.voxel_3d_observability import Voxel3DObservability
...
class HlsmObservationFunction(ObservationFunction):
    ...
    def forward(self, observation: TeachObservation, prev_state: Union[TeachSpatialStateRepr, None], goal: Union[TeachSubgoal, None]) -> TeachSpatialStateRepr:
