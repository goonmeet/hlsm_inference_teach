...
from lgp.models.teach.projection.voxel_mask_to_image_mask import VoxelMaskToImageMask
...
class TeachSubgoal(Subgoal, Task):
    ...
    @classmethod
    def from_action_and_observation(cls, action: TeachAction, observation: TeachObservation):
        # Action type
